			...
			<div class="span12">
				<div class="portlet box blue">
					<div class="portlet-title">
						...
						<div class="caption"><i class="icon-reorder"></i>私募股权类/添加</div>
								   <div class="tools">
					  ...
					  <div class="portlet-body form">
						<form action="/Ying_Second/simu/add" class="form-horizontal" method="post">					
									...
									<label class="control-label">年化收益:</label>
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="year_rate" />											
										</div>
									</div>
									...
									<label class="control-label">返佣比例:</label>
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="ratio" />											
										</div>
									</div>
