			...
			<div class="span12">
				<div class="portlet box blue">
					<div class="portlet-title">
						...
						<div class="caption"><i class="icon-reorder"></i>海外配置修改</div>
								   <div class="tools">
					  ...
					  <div class="portlet-body form">
						<form action="/Ying_Second/oversea/update" class="form-horizontal" method="post">	
						    		<input type="hidden" name="id" value="${oc.id }">
									<div class="control-group">
										<label class="control-label">标题 ：</label>
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="title" value="${oc.title }"/>
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="child_title" value="${oc.child_title }"/>                                
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<select  tabindex="1" name="status">
												<option value="${oc.status }">请选择</option>
...
<img src="/Ying_Second/img/baoxian/youyuan.jpg" width="70px" height="50px"></img><input type="radio" name="oversea_icon" value="/Ying_Second/img/baoxian/youyuan.jpg">										
									...
									<label class="control-label">排序值:</label>
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="sortColum" value="${oc.sortColum }"/>											
										</div>
									</div>
