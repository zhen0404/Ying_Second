...
<body>
	...
	<div style="width: 1002px; height: 94px; margin: 0 auto;">
		<iframe src="/Ying_Second/top" scrolling="no"
	...
	<div class="container">
		<div class="kcenter">
			<ul>
				<li><a href="/Ying_Second/frontSubject/showsubject">产品中心</a></li>
				<li><a href="/Ying_Second/frontJournalism">新闻中心</a></li>
				<li><a href="/Ying_Second/frontLoad">下载中心</a></li>
				<li><a href="/Ying_Second/frontCollege">盈+商学院</a></li>
				<li><a href="/Ying_Second/frontStudy">投研中心</a></li>
				<li><a
					href="/Ying_Second/fontmember/zhu">我的加法库</a></li>
			</ul>
			<div
				style="position: absolute; left: 485px; top: 410px; font-size: 18px;">
				<a href="/Ying_Second/frontStudy"
					style="color: transparent">投研中心</a>
			</div>
			<div
				style="position: absolute; left: 720px; top: 390px; font-size: 18px;">
				<a href="/Ying_Second/fontmember/zhu"
