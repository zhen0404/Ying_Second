					...
					<div class="span12">
						...
						<div class="portlet box green">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-cogs"></i>➤查看公告</div>
							...
							<div class="portlet-body flip-scroll">
											...
											标题：<input type="text" name="title" value="${pushNotice.title }"readonly>
										</form>
								<div class="row-fluid">
					          <div class="span12">
								...
								<div class="control-group">
										...
										<div class="controls">
											<textarea class="span12 wysihtml5 m-wrap"name="content" rows="6"readonly>${pushNotice.content }</textarea>
										</div>
									</div>
							    </div>
						     </div>
　　　　　　　　　　　　　　　　　　　　　　<form action="/Ying_Second/GongGao/manager" method="post">
											<input type="submit" value="返回"style="text-align: center" > 
										</form>
