				...
				<div class="portlet box blue">
					<div class="portlet-title">
					  ...
					  <div class="portlet-body form">
						<form action="/Ying_Second/subject/addSubject" class="form-horizontal" method="post">					
					...
					<div class="span12">
						...
						<div class="portlet box green">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>特定属性</div>
								...
								<div class="control-group">
										<label class="control-label">债权编号</label>
										<div class="controls">
									...
									<div class="control-group">
										<label class="control-label">保障平台</label>
										<div class="controls">
											<input class="span6 m-wrap" type="text" />
										</div>
									</div>
						   ...
						   <div class="portlet box red">
							<div class="portlet-title">
								...
								<div class="control-group">
										...
										<div class="controls">
											<textarea class="span12 wysihtml5 m-wrap" rows="6" name="projectDetails"></textarea>
										</div>
									</div>
							 </div>
						</div>
						   ...
						   <div class="portlet box black">
							<div class="portlet-title">
								...
								<div class="control-group">
										...
										<div class="controls">
											<textarea class="span12 wysihtml5 m-wrap" rows="6" name="safetyControl"></textarea>
										</div>
									</div>
							    </div>
						     </div>
