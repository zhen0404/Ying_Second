					...
					<div class="span12">
						...
						<div class="portlet box green">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-cogs"></i>➤编辑公告</div>
							...
							<div class="portlet-body flip-scroll">
                                            <form action="/Ying_Second/GongGao/serTor" method="post">
                                            <input type="hidden" name="id" value="${pushNotice.id} " >
											标题：<input type="text" name="title" value="${pushNotice.title } ">
					          ...
					          <div class="span12">
								...
								<div class="control-group">
										...
										<div class="controls">
											<textarea class="span12 wysihtml5 m-wrap" rows="6" name="content">${pushNotice.content }</textarea>
										</div>
									</div>
							    </div>
						     </div>
